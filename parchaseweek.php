          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                $query="select purchaseitems.pur_item, perchase.p_quantity, perchase.p_price, perchase.p_paid, perchase.p_remaing, perchase.p_remainingpaid, perchase.p_date from perchase inner join purchaseitems on purchaseitems.pur_id=perchase.pur_id where perchase.p_date BETWEEN (NOW() - INTERVAL 7 DAY) AND NOW()";
                ...
                <?php } ?>
                  ...
                  <tr>
                    <?php
                $query="select sum(p_price) as totalprice from perchase where p_date BETWEEN (NOW() - INTERVAL 7 DAY) AND NOW()";
                $result= $conn->query($query) or die("Query Error");
                foreach ($result as $row) {
                 ?>
                    <th>Total Parchase <b>RS: <?php echo $row['totalprice']; ?></b></th>
                    <th></th>
                    <th></th>
                    <th></th>
                    <th></th>
                ...
                // foreach ($result as $row) {
                 ?>
                  <!-- <h5>Total parchase is <b>RS: <?php //echo $row['totalprice']; ?></b></h5> -->
                <?php //} ?>
                </table>
              </div>
              <!-- /.card-body -->
