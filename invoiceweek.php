        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Week Invoices</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Week Invoices</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                $query="select neworder.or_id, neworder.invoiceno, neworder.or_date, neworder.or_grandtotal, employees.e_name from neworder left join employees on neworder.e_id = employees.e_id where neworder.or_date BETWEEN (NOW() - INTERVAL 7 DAY) AND NOW()";
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php 
                $query="SELECT or_id, invoiceno, or_grandtotal, or_date, orcancelreasonradio, orcancelreason, orcanceldate FROM cancelorder WHERE orcanceldate BETWEEN (NOW() - INTERVAL 7 DAY) AND NOW()";
                $result= $conn->query($query) or die("Query Error");
                foreach ($result as $row) {
                 ?>
                  <tr>
                ...
                <br>
                    ...
                    <?php
                      ...
                      <br>
                        <?php
                      $qu="select menue.m_item, sum(sales.sa_quantity) as qty, neworder.or_date FROM sales INNER JOIN menue ON menue.m_id= sales.m_id INNER JOIN neworder ON neworder.or_id= sales.or_id where neworder.or_date BETWEEN (NOW() - INTERVAL 7 DAY) AND NOW() group by menue.m_id having sum(sales.sa_quantity)";
